    ...
    <Controller page={routes.Page.Home} results={<DomainResults showTlds />}>
      <TwoColumnLayout>
        <>
          ...
          <p>
            Мы применяем купон на <strong>4.99$ для доменных имен .com</strong>, которые вы покупаете в GoDaddy. Это
            предложение действительно только для одной покупки .com, и не включает в себя плату ICANN в размере 0,18$ за
            доменное имя в год. Это отличное предложение!
          </p>
